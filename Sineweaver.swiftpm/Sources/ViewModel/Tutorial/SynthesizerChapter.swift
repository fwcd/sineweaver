...
enum SynthesizerChapter: Hashable, CaseIterable, Comparable {
    ...
    var details: [String] {
        ...
        case .waveOscillator:
            [
                #"There are other kinds of waves we can generate too. The perhaps most common types are **saw waves** and **square waves**. Try changing the wave type in the drop down menu and see how that affects the sound. You may wish to turn your volume down a bit, since saw and square waves "feel louder" due to being harmonically richer."#,
            ]
        case .pianoOscillator:
            [
        ...
        case .lfo:
            [
                ...
                "A very simple form of modulation is **amplitude modulation** where the signals are effectively multiplied together. Try pressing and holding a piano key. How does changing the LFO frequency affect the sound?",
        ...
        case .filter:
            [
                ...
                "To make things interesting, we use a saw wave here. Try tweaking the cutoff frequency and the modulation strength of the filter below, as well as the LFO frequency, and see how the sound changes when you play the oscillator's piano! If the synthesizer is too large to fit your screen, you can scroll around.",
            ]
        case .unisonDetune:
            [
